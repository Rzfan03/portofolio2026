...
const App = () => {
  ...
  return (
    <main className="bg-zinc-900">
      ...
      <AnimatedContent>
        <section id="about" className="py-24 flex justify-center items-center border-b border-zinc-800/50">
          <div className="w-full max-w-7xl px-6 flex flex-col gap-12">
            <SplitText className="text-4xl text-white" text="About me" />
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <img className="w-full max-w-md aspect-[3/4] object-cover rounded-sm grayscale hover:grayscale-0 transition-all duration-500" src="photo.png" alt="Profile" />
      ...
      <AnimatedContent>
        <section id="skills" className="py-24 flex justify-center border-b border-zinc-800/50">
          <div className="w-full max-w-7xl px-6">
            <SplitText className="text-4xl mb-12 text-white" text="My Skills" />
            <div className="space-y-10">
              <div className="flex flex-col md:flex-row gap-8">
                <h1 className="text-zinc-500 text-xl w-32 shrink-0 pt-2">Intermediate</h1>
                <div className="flex flex-wrap gap-3">
                  {Intermediate.map((item) => (
                    <div key={item.name} className="bg-zinc-900 border border-zinc-800 p-2 px-4 flex items-center gap-3 hover:border-zinc-400 transition-all">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <h1 className="text-zinc-500 w-32 text-xl shrink-0 pt-2">Beginner</h1>
                <div className="flex flex-wrap gap-3">
                  {Beginner.map((item) => (
                    <div key={item.name} className="bg-zinc-900 border border-zinc-800 p-2 px-4 flex items-center gap-3 hover:border-zinc-400 transition-all">
                      <item.icon className="text-zinc-400" size={18} />
      ...
      {/* Contact Section */}
      <AnimatedContent>
        <section id="contact" className="py-24 flex flex-col justify-center items-center px-6">
          <div className="w-full max-w-4xl text-center">
            <SplitText text="Get In Touch" className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tighter" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <a href="https://discord.com/users/1241671009820741632" target="_blank" className="flex items-center justify-between p-6 border-2 border-zinc-800 hover:border-zinc-400 transition-all group">
                <div className="flex items-center gap-4">
                  <SiDiscord className="text-zinc-400 group-hover:text-[#5865F2] text-3xl transition-all" />
                  <div><h4 className="text-white font-bold">Discord</h4><p className="text-zinc-500 text-sm">@rzfan_</p></div>
                </div>
                <span className="text-zinc-600">→</span>
              </a>
              <a href="https://github.com/Rzfan03" target="_blank" className="flex items-center justify-between p-6 border-2 border-zinc-800 hover:border-zinc-400 transition-all group">
                <div className="flex items-center gap-4">
                  <SiGithub className="text-zinc-400 group-hover:text-white text-3xl transition-all" />
                  <div><h4 className="text-white font-bold">GitHub</h4><p className="text-zinc-500 text-sm">Rzfan03</p></div>
                </div>
                <span className="text-zinc-600">→</span>
              </a>
              <a href="https://www.linkedin.com/in/rizqy-fajrul-syabani-b65002359/" target="_blank" className="flex items-center justify-between p-6 border-2 border-zinc-800 hover:border-zinc-400 transition-all group">
                <div className="flex items-center gap-4">
                  <SiLinkedin className="text-zinc-400 group-hover:text-[#0A66C2] text-3xl transition-all" />
                  <div><h4 className="text-white font-bold">LinkedIn</h4><p className="text-zinc-500 text-sm">Rizqy Fajrul</p></div>
                </div>
                <span className="text-zinc-600">→</span>
              </a>
              <a href="mailto:Fajrulsyaban47@gmail.com" className="flex items-center justify-between p-6 border-2 border-zinc-800 hover:border-zinc-400 transition-all group">
                <div className="flex items-center gap-4">
                  <SiGmail className="text-zinc-400 group-hover:text-[#EA4335] text-3xl transition-all" />
                  <div><h4 className="text-white font-bold">Email</h4><p className="text-zinc-500 text-sm">Contact Me</p></div>
                </div>
                <span className="text-zinc-600">→</span>
              </a>
            </div>
            <div className="mt-20 text-zinc-700 font-mono text-xs">© 2026 - Rzfan03</div>
          </div>
        </section>
      </AnimatedContent>
    </main>
